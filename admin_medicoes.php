              ...
              <?php else: ?>
                <?php while ($linha = mysqli_fetch_assoc($resultado)): ?>
                  <tr>
                    ...
                    <td data-label="Observação" class="cell-observation"><?php echo htmlspecialchars(trim((string)($linha['observacao'] ?? '')) !== '' ? trim((string)($linha['observacao'] ?? '')) : 'Nenhuma observação escrita'); ?></td>

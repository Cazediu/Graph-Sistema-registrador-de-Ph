...
<head>
  ...
  <title>Admin - Lista de medições</title>
  ...
  <div class="container wide-container">
    ...
    <div class="topbar">
      <div>
        ...
        <div class="small">Lista completa das medições do laboratório com filtros e histórico de alterações.</div>
      </div>
    </div>
    ...
    <?php if ($mensagem): ?><div class="msg success"><?php echo htmlspecialchars($mensagem); ?></div><?php endif; ?>
    <?php if ($erro): ?><div class="msg error"><?php echo htmlspecialchars($erro); ?></div><?php endif; ?>
    <div class="page-grid admin-page-grid">
          ...
          <table>
            ...
            <tbody>
              <?php if (mysqli_num_rows($resultado) === 0): ?>
                <tr><td colspan="9">Nenhuma medição encontrada.</td></tr>
              <?php else: ?>
                <?php while ($linha = mysqli_fetch_assoc($resultado)): ?>
                  <tr>
                    ...
                    <td class="cell-observation"><?php echo htmlspecialchars(trim((string)($linha['observacao'] ?? '')) !== '' ? trim((string)($linha['observacao'] ?? '')) : 'Nenhuma observação escrita'); ?></td>
